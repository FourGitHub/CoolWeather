        ...
        switch (view.getId()) {
            ...
            case R.id.btn_current_position:
                if (view.getTag(R.id.btn_current_position) != null) {
                    ...
                    ToastUtil.showToast(getApplicationContext(), "客官您别着急啊 ~", Toast.LENGTH_SHORT);
                }
                break;
                ...
                */
                new Thread(() -> {
                    ...
                    while ((mLocation = mLocationManager
                        ...
                        mLocationManager
                                .requestLocationUpdates(2000, 1, criteria, mListener, mLooper);
                    }
                    afterLocateSuccess();
...
//        }
    ...
    private void requestGPSLicence() {
        ActivityCompat
                .requestPermissions(SearchActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    }
            ...
            Observer<SearchedCities> observer = new Observer<SearchedCities>() {
                ...
                public void onNext(SearchedCities searchedCities) {
                    if (searchedCities.getHeWeather6()
                                      ...
                                      .toLowerCase()
                                      .equals("ok")) {
                        SearchedCities.HeWeather6Bean.BasicBean cityInfo = searchedCities.getHeWeather6()
                                                                                         .get(0)
                                                                                         .getBasic()
                                                                                         .get(0);
                        String location = cityInfo.getLocation() + ", " + cityInfo.getAdmin_area() + ", " + cityInfo
                                .getCnty();
